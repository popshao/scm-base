...
public class EncryptUtil {
    private static String strDefaultKey = "yiyaowang";
    ...
    public static void main(String[] args) {
        try {
            EncryptUtil encrypt = new EncryptUtil("JINBO");
            log.info(encrypt.encrypt("SCM_KEY"));
            log.info(encrypt.decrypt("93979c53251394b8"));
        } catch (Exception e) {
        }
    }
